...
.SYNOPSIS
    Pester tests for the TeamsFun module manifest file.
...
.EXAMPLE
    Invoke-Pester -Path .\Tests\Private\apiKeys\Get-TeamsFunKey.Tests.ps1

    Runs a pester test and outputs simple results

.EXAMPLE
    Invoke-Pester -Path .\Tests\Private\apiKeys\Get-TeamsFunKey.Tests.ps1 -Output Detailed
...
Describe "Testing the [ $buildTarget ] version of [ $moduleName ] with [ $pester_TestName ]" {
    ...
    Context "[ $moduleName.psd1 ] general manifest data" {
        ...
        It "Manifest [ RootModule ] has valid data" {
            $Module.RootModule | Should -Be 'TeamsFun.psm1'
        }
        ...
        It "Manifest [ GUID ] has valid data" {
            $Module.GUID | Should -Be 'c1f214c7-2be5-4a5e-b51e-c9ac698234c5'
        }
        ...
        It "Manifest [ Copyright ] has valid data" {
            $Module.Copyright | Should -Be 'https://github.com/Celerium/TeamsFun/blob/main/LICENSE'
        }
        ...
        It "Manifest [ NestedModules ] has valid data" {
            switch ($buildTarget){
                ...
                'notBuilt'  { ($Module.NestedModules.Name).Count | Should -Be 4 }
            }
        }
        ...
        It "Manifest [ AliasesToExport ] has alias" {
            switch ($buildTarget){
                'built'     { ($Module.ExportedAliases | Measure-Object).Count |  Should -Be 0 }
                'notBuilt'  { $Module.ExportedAliases |  Should -Not -BeNullOrEmpty }
            }
        }

        It "Manifest [ Tags ] has valid data" {
            $Module.PrivateData.PSData.Tags | Should -Contain 'TeamsFun'
        ...
        It "Manifest [ LicenseUri ] has valid data" {
            $Module.LicenseUri | Should -Be 'https://github.com/Celerium/TeamsFun/blob/main/LICENSE'
        }

        It "Manifest [ ProjectUri ] has valid data" {
            $Module.ProjectUri  | Should -Be 'https://github.com/Celerium/TeamsFun'
        }

        #It "Manifest [ IconUri ] has valid data" {
        #    $Module.IconUri  | Should -Be 'https://raw.githubusercontent.com/Celerium/TeamsFun/main/.github/images/Celerium_PoSHGallery_TeamsFun.png'
        #}

        It "Manifest [ ReleaseNotes ] has valid data" {
            $Module.ReleaseNotes  | Should -Be 'https://github.com/Celerium/TeamsFun/blob/main/README.md'
        }
