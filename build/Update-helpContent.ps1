...
.PARAMETER helpDocsPath
    ...
    Reference:
        Yes - "TeamsFun\docs"
        NO  - "TeamsFun\TeamsFun\docs"

    Example: "C:\Celerium\Projects\TeamsFun\docs"

.PARAMETER csvFilePath
    Location where the tracking CSV is located including the CSV file name

    The tracking CSV should be located in "TeamsFun\docs"
    Reference:
        Yes - "TeamsFun\docs\Endpoints.csv"
        NO  - "TeamsFun\TeamsFun\docs\Endpoints.csv"

    Example: "C:\Celerium\Projects\TeamsFun\docs\Endpoints.csv"

.PARAMETER githubPageUri
    Base url of the modules github pages

    Example: "https://celerium.github.io/TeamsFun"
...
.EXAMPLE
    .\Update-helpContent.ps1
        -moduleName TeamsFun
        -helpDocsPath "C:\Celerium\Projects\TeamsFun\docs"
        -csvFilePath "C:\Celerium\Projects\TeamsFun\docs\Endpoints.csv"
        -githubPageUri "https://celerium.github.io/TeamsFun"
...
Have a look around and if you would like to contribute please read over the [Contributing guide](https://github.com/Celerium/TeamsFun/blob/main/.github/CONTRIBUTING.md)
"@
        }
