...
The "TeamsFun" team and community take all security bugs in "TeamsFun" seriously. Thank you for improving the security of "TeamsFun". We appreciate your efforts and responsible disclosure and will make every effort to acknowledge your contributions.
...
- "TeamsFun" will confirm the problem and determine the affected versions.
- "TeamsFun" will audit code to find any potential similar problems.
- "TeamsFun" will prepare fixes for all releases still under maintenance. These fixes will be released as fast as possible.
